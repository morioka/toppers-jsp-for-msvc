 ...
 */
#define	INHNO_SERIAL_IN1	INT_S0RACK
#define	INHNO_SERIAL_OUT1	INT_S0TNACK
#define INHNO_SERIAL_IN2	INT_S1RACK
#define INHNO_SERIAL_OUT2	INT_S1TNACK
