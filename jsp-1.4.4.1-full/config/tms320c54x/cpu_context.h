 ...
 * 
 *  @(#) $Id: cpu_context.h,v 1.6 2003/12/04 08:25:44 honda Exp $
 */
...
activate_context(TCB *tcb)
{
  ...
  sp = ((VH *)tcb->tinib->stk) + tcb->tinib->stksz;
  *--sp = (VH)ext_tsk;
  *--sp = (VH)(tcb->tinib->exinf);
  *--sp = (VH)(tcb->tinib->task);
  tcb->tskctxb.sp = sp;
 ...
 */
#define	ACTIVATED_STACK_SIZE	(sizeof(VH) * 3)
