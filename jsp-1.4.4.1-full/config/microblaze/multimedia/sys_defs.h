 ...
 * 
 *  @(#) $Id: sys_defs.h,v 1.3 2004/02/05 09:16:26 honda Exp $
 */


/*
 *  システムに依存する定義（MIRE-MULTI）
 *
 ...
 *  起動メッセージのターゲット名
 */
#define	TARGET_NAME	"MultiMddia(Microblaze)"
 ...
 *  TIMER のベースアドレス
 */
#define TIMER_BASE 0xFFFF8000   

/*
 * カーネルで使用する UART のベースアドレス
 */
#define UART_BASE 0xFFFF8200

/*
 * YG0130のベースアドレス
 */
#define  YG0130_0_BASE_ADDR  0xFFFF8900    
