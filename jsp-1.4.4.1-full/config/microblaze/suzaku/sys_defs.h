 ...
 *  Copyright (C) 2004 by Atmark Techno, Inc.
 * 
 ...
 * 
 *  @(#) $Id: sys_defs.h,v 1.2 2007/05/08 07:47:39 honda Exp $
 */
 ...
 *  起動メッセージのターゲット名
 */
#define	TARGET_NAME	"SUZAKU(Microblaze)"
 ...
 *  JSPカーネル動作時のメモリマップ
 *  BRAM
 *  0x00000000 - 0x0000001f    割り込みベクタ
 *  0x00000400 - 0000000fff    タスク独立部用スタック
 *  SDRAM
 *  0x80000000 - 0x8001ffff コード領域(128KB)
 *  0x80020000 - 0x8003ffff データ領域(128KB)
 *
 */
 ...
 *  タイマ値の内部表現とミリ秒単位との変換
 */
#define TIMER_CLOCK		51610	/* 51609.6 */
 ...
 *  INTC のベースアドレス
 */
#define INTC_BASE 0xFFFF3000

/*
 *  TIMER のベースアドレス
 */
#define TIMER_BASE 0xFFFF1000

/*
 * カーネルで使用する UART のベースアドレス
 */
#define UART_BASE 0xFFFF2000

/*
 * SMC91C113のベースアドレス
 */
#define  SMC91C113_BASE_ADDR  0xffe00000
