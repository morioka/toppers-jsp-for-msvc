 ...
 */
#include "cq_d70f3716gc.h"

/*
 *  起動メッセージのターゲットシステム名
 */
#define	TARGET_NAME	"CQBB+V850ES/JG2"
 ...
 */
#ifdef DEBUGGER
#define	STACKTOP	(IRAM_TOP+IRAM_SIZE - 16)	/* 非タスクコンテキスト用のスタックの初期値 */
#else
