 ...
 *  わない．
 * 
 *  @(#) $Id: sys_config.h,v 1.3 2007/04/19 06:10:19 honda Exp $
 */
 ...
 *  起動メッセージのターゲットシステム名
 */
#define	TARGET_NAME	"TOSHIBA TLCS-900/L1 SERIES TRAINING BOARD"

/*
 *  vxget_tim をサポートするかどうかの定義
 */
/*#define	SUPPORT_VXGET_TIM	*/
/* タイマカウンタ値が取得できないため未サポートとする	*/
