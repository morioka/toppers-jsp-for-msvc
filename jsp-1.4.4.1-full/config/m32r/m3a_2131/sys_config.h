 ...
 * 
 *  @(#) $Id: sys_config.h,v 1.2 2007/05/30 08:38:51 honda Exp $
 */

/*
 *	ターゲットシステム依存モジュール（M32R / M3A-2131用）
 */
 ...
 *  シリアルポート番号に関する定義
 */
#define	LOGTASK_PORTID		1	/* ログタスクが出力用に用いるシリアルポート番号 */
