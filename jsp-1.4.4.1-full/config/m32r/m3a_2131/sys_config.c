 ...
 * 
 *  @(#) $Id: sys_config.c,v 1.2 2007/05/30 08:38:51 honda Exp $
 */

/*
 *	ターゲットシステム依存モジュール（M3A-2131用）
 */
...
sys_initialize()
{
	sil_wrh_mem((void *)0xef106e, 0);		//ポート7を使用する
	sil_wrb_mem((void *)0xef1047, 0xff);	//出力モード
