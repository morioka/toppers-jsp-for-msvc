 ...
 *  タイマーとその他のデバイスレジスタ
 */
#define TADR_SFR_TBSR           0x340			/* timerB3,4,5カウント開始フラグ */
...
#define TADR_SFR_TB3            0x350			/* timerB3レジスタ */
#define TADR_SFR_TB4            0x352			/* timerB4レジスタ */
#define TADR_SFR_TB5            0x354			/* timerB5レジスタ */
#define	TADR_SFR_TB3MR          0x35b			/* timerB3モードレジスタ */
#define	TADR_SFR_TB4MR          0x35c			/* timerB4モードレジスタ */
#define	TADR_SFR_TB5MR          0x35d			/* timerB5モードレジスタ */
