 ...
 *   タイマへの入力クロックの分周比設定
 *
 *   CQ_SH7262では、PΦクロックが24MHz
 *   0: PΦ/8   3MHz      tick 3000  0.33 μsec
 *   1: PΦ/32  750KHz    tick 750   1.33 μsec
 *   2: PΦ/128 187.5KHz  tick 187   5.33 μsec
 *   3: PΦ/512 46.875KHz tick 47    21.33 μsec
 */
#define TCR_CKS         0
