 ...
 *
 *    ROM化時
 *      0x0000,0000                コード領域(16MB)
 *                  - 0x00ff,ffff  外付Flash終了
 *      0x0c00,0000 -              データ領域(32MB)
 *                  - 0x0dff,ffff  外付SDRAM終了
 *      0xfff8,0000 -              タスク独立部用スタック(64KB)
 *                  - 0xfff8,ffff  内蔵RAM終了
 *
 *    RAM動作時
 *      0x0c00,0000 -              コード/データ領域(32MB)
 *                  - 0x0dff,ffff  外付SDRAM終了
 *      0xfff8,0000 -              タスク独立部用スタック(64KB)
 *                  - 0xfff8,ffff  内蔵RAM終了
 */
 ...
 */
#define	INNER_RAM_ADDRESS	0xFFF90000
