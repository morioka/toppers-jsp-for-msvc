...
/*
 *  JSPカーネル動作時のメモリマップ
 *      0x0000,0000 - 0x0003,ffff  コード領域:ROM(256KB)
 *      0x0020,0000 - 0x0021,ffff  コード領域:RAM,データ領域(128K)
 *      0xffff,d000 - 0xffff,ffff  タスク独立部用スタック メモリ終了
 */

/*
 *　非タスクコンテキスト用スタックの初期値
 */
#define STACKTOP    	 0x00000000
 ...
 *  システムログに用いるシリアルポート番号
 */
#define CONSOLE_PORTID  1	/* コンソールに用いるシリアルポート番号１に固定 */
